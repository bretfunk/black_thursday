...
class TransactionRepositoryTest < Minitest::Test
  ...
  def setup
    @tr = TransactionRepository.new("./data/transactions.csv", "se")
  end
  ...
  def test_it_returns_transaction_result_for_valid_credit_card_number_search
    result = tr.find_all_by_credit_card_number(4848466917766329)
  ...
  def test_find_all_by_result_returns_empty_for_invalid_transaction_result_entry
    result = tr.find_all_by_result("meh")
